...
class VentasTabla(tk.Frame):
    ...
    def initWidgets(self):
        ...
        def Filtro():
            ...
            c.execute("SELECT * FROM pedido WHERE estado = ?", ("Entregado",))
                ...
                if seleccion == "ID":
                    ...
                    for registro in registros:
                        if busqueda in str(registro[0]): 
                            ...
                            if count % 2 == 0:
                                treeTabla.insert(parent="", index=0, iid=count, values=( registro[0], registro[1], cliente[2], domicilio, registro[4], registro[5], registro[6], registro[7]), tags="evenrow")
                            else:
                                treeTabla.insert(parent="", index=0, iid=count, values=( registro[0], registro[1], cliente[2], domicilio, registro[4], registro[5], registro[6], registro[7]), tags="oddrow")    
                            count+=1
        ...
        treeTabla['columns'] = ("ID", "Fecha", "Cliente", "idDomicilio", "infoAdicional", "Mensaje", "Valor", "Medio de Pago")
